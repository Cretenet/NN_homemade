...
def cost_function(Y, Yhat, name):
    if name == 'MSE' : return MSE(Y, Yhat)
    elif name == 'cross_entropy' : return cross_entropy(Y, Yhat)
    elif name == 'binary_cross_entropy' : return binary_cross_entropy(Y, Yhat)


def derivative_cost_function(Y, Yhat, name):
    if name == 'MSE' : return derivative_MSE(Y, Yhat)
    elif name == 'cross_entropy' : return derivative_cross_entropy(Y, Yhat)
    elif name == 'binary_cross_entropy' : return derivative_binary_cross_entropy(Y, Yhat)
