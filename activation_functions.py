...
def activation_function(matrix, name):
    ...
    elif name == 'softmax' : return softmax(matrix)
    elif name == 'identity' : return identity(matrix)
...
def derivative_activation_function(matrix,name):
    ...
    elif name == 'softmax' : return derivative_softmax(matrix)
    elif name == 'identity' : return derivative_identity(matrix)
